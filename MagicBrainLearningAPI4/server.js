...
app.post('/signin', (req, res) => {
    bcrypt.compare("Mindaugas3", '$2a$10$UMBy/Fb6y93TRc8EYyOY5eTEMMhRQVll2iV0KLfzoVra2yIsl2.Ke', function(err, res) {
        console.log('Result: ', res);
    });
    
    bcrypt.compare("veggies", '$2a$10$UMBy/Fb6y93TRc8EYyOY5eTEMMhRQVll2iV0KLfzoVra2yIsl2.Ke', function(err, res) {
        console.log('Result: ', res);
    });
